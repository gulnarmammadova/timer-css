    ...
    <div className={styles.timerContainer}>
      <div className={styles.timerControls}>
        <div className={styles.timerBlock}>
          <p className={styles.timerNumber}>{formatTime(time).hours}</p>
        ...
        <div className={styles.timerBlock}>
          <p className={styles.timerNumber}>{formatTime(time).minutes}</p>
          <div className={styles.timerController}>
        ...
        <div className={styles.timerBlock}>
          <p className={styles.timerNumber}>{formatTime(time).seconds}</p>
          <div className={styles.timerController}>
